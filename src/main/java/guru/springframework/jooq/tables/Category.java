...
public class Category extends TableImpl<Record> {
    ...
    /**
     * The reference instance of <code>spring_guru_recipe.category</code>
     */
    ...
    /**
     * Create an aliased <code>spring_guru_recipe.category</code> table reference
     */
    ...
    /**
     * Create a <code>spring_guru_recipe.category</code> table reference
     */
    public Category() {
    ...
    public UniqueKey<Record> getPrimaryKey() {
        return Internal.createUniqueKey(Category.CATEGORY, DSL.name("KEY_category_PRIMARY"), new TableField[] { Category.CATEGORY.ID }, true);
    }

    @Override
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(
              Internal.createUniqueKey(Category.CATEGORY, DSL.name("KEY_category_PRIMARY"), new TableField[] { Category.CATEGORY.ID }, true)
        );
    }
