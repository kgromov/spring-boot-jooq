...
public class TimeLoggerAspect {
    ...
    @Around("@annotation(com.recipe.application.services.profiling.Profiling)")
    ...
    @Around("within(com.recipe.application.repositories.custom.JooqSqlResultMapperRepository+) ||" +
